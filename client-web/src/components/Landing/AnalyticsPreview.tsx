      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="relative">
          ...
          <motion.div
            ...
            className="rounded-2xl border border-border/50 bg-card/50 backdrop-blur-xl shadow-2xl overflow-hidden"
          >
            {/* Window Header */}
            <div className="flex items-center gap-2 px-4 py-3 border-b border-border/50 bg-muted/30">
              ...
              <div className="flex-1 text-center">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-background/50 text-xs text-muted-foreground font-medium">
                  <span className="w-2 h-2 rounded-full bg-primary animate-pulse" />
                  flowmap.app/dashboard
                </div>
              </div>
            </div>
            ...
            <div className="p-6 md:p-8 grid lg:grid-cols-2 gap-8">
              {/* Main Chart */}
              <div className="glass-card p-6 lg:col-span-2 border-0 bg-background/40">
              ...
              {/* Bar Chart */}
              <div className="glass-card p-6 border-0 bg-background/40">
